...
@section('content')
<section class="min-h-[calc(100vh-64px)] bg-slate-50 py-20 px-6">
    <div class="max-w-5xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-start">
            ...
            <div class="lg:col-span-2">
                <p class="text-xs font-semibold text-teal-600 uppercase tracking-widest mb-3">Contatti</p>
                ...
                <div class="space-y-5">
                    <div class="flex items-start gap-4">
                        <div class="w-10 h-10 rounded-xl bg-teal-50 flex items-center justify-center shrink-0 mt-0.5">
                            <svg class="w-5 h-5 text-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                            </svg>
                        </div>
                        <div>
                            <p class="font-semibold text-gray-900 text-sm">Risposta rapida</p>
                            <p class="text-gray-500 text-sm">Entro 24 ore nei giorni lavorativi</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        <div class="w-10 h-10 rounded-xl bg-teal-50 flex items-center justify-center shrink-0 mt-0.5">
                        ...
                        <div>
                            <p class="font-semibold text-gray-900 text-sm">Supporto in italiano</p>
                            <p class="text-gray-500 text-sm">7 giorni su 7</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        <div class="w-10 h-10 rounded-xl bg-teal-50 flex items-center justify-center shrink-0 mt-0.5">
                        ...
                        <div>
                            <p class="font-semibold text-gray-900 text-sm">Demo dal vivo</p>
                            <p class="text-gray-500 text-sm">Ti mostriamo tutto in una videochiamata</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-3">
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
                    ...
                    <form method="POST" action="{{ route('contact.store') }}" class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input type="text" id="name" name="name"
                                       ...
                                       class="w-full px-4 py-2.5 rounded-xl border text-sm transition
                                              {{ $errors->has('name') ? 'border-red-300 bg-red-50 focus:ring-red-300' : 'border-gray-300 focus:border-teal-400 focus:ring-teal-100' }}
                            ...
                            <div>
                                ...
                                <input type="email" id="email" name="email"
                                       ...
                                       class="w-full px-4 py-2.5 rounded-xl border text-sm transition
                                              {{ $errors->has('email') ? 'border-red-300 bg-red-50 focus:ring-red-300' : 'border-gray-300 focus:border-teal-400 focus:ring-teal-100' }}
                                              focus:outline-none focus:ring-2">
                                @error('email')
                                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input type="tel" id="phone" name="phone"
                                       ...
                                       class="w-full px-4 py-2.5 rounded-xl border border-gray-300 text-sm transition
                            ...
                            <div>
                                ...
                                <select id="subject" name="subject"
                                        class="w-full px-4 py-2.5 rounded-xl border text-sm transition bg-white
                                               {{ $errors->has('subject') ? 'border-red-300 bg-red-50 focus:ring-red-300' : 'border-gray-300 focus:border-teal-400 focus:ring-teal-100' }}
                                               focus:outline-none focus:ring-2">
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" rows="5"
                                      ...
                                      class="w-full px-4 py-2.5 rounded-xl border text-sm transition resize-none
                                             {{ $errors->has('message') ? 'border-red-300 bg-red-50 focus:ring-red-300' : 'border-gray-300 focus:border-teal-400 focus:ring-teal-100' }}
                        ...
                        <button type="submit"
                                class="w-full bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3.5 rounded-xl transition text-sm shadow-sm shadow-teal-200">
                            Invia messaggio
                        </button>

                        <p class="text-xs text-gray-400 text-center">
                            Inviando il messaggio accetti la nostra
                            <a href="{{ route('legal.privacy') }}" class="text-teal-600 hover:underline">Privacy Policy</a>.
                        </p>
                    </form>
                </div>
            </div>
